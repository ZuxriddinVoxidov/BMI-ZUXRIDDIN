  ...
  return (
    ...
    >
      ...
      <div className="px-3 py-4 border-t border-gray-100 dark:border-gray-800 space-y-1">
        ...
        <button
          onClick={() => logout()}
          className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-red-500 hover:bg-red-50 dark:hover:bg-red-950 w-full transition-all touch-manipulation"
        >
          <LogOut size={20} />
