        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {[
              ...
              { icon: '✉️', bg: 'bg-blue-100 text-blue-600', title: 'Email manzil', lines: ['admin@eduflow.uz'], link: 'mailto:admin@eduflow.uz' },
            ...
            <div className="flex gap-3">
              {[
                { label: 'Telegram', bg: 'bg-blue-500 hover:bg-blue-600', icon: '✈️', href: 'https://t.me/eduflow46' },
