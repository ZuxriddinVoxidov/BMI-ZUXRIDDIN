      ...
      <form onSubmit={handleSave} className="space-y-3">
        ...
        <div>
          ...
          <p className="text-[11px] text-gray-400 mt-1.5">
            Chat ID olish uchun: Telegramda <span className="font-semibold text-indigo-500">@eduflow_notify_bot</span> ga <code className="bg-gray-100 px-1 rounded">/start</code> yuboring
          </p>
        </div>
